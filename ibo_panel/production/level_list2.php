    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered">
            <thead><tr><th>Sr. no.</th><th>D ID</th><th>ID status</th><th>Diamond Status</th><th>Name</th></tr></thead>
            <?php
            $a=0;
            ...
            ?>
                <td><?php echo $a;?></td><td><?php echo $temp[$x];?></td><td><?php echo $lk;?></td><td><?php echo $lkd;?></td><td><?php echo $temp1[$x];?></td>
            </tr>
            <?php
            }?>
        </table>
