...
<html lang="en">
  <head>
    ...
    <title>0CHARGES || change password</title>
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            {
                if($_POST[old_pass]==$d_info[password])
                {
                    if($_POST[n_pass]==$_POST[c_pass])
                    {
                //mysql_query("INSERT INTO `password_change_history` (`pch_id`, `d_id`, `date`, `time`, `old_pass`, `new_pass`, `o_by`) VALUES (NULL, '$_SESSION[d_id]', '$date', '$time', '$_POST[old_pass]', '$_POST[n_pass]', 'd');")or die("Profile not update please try again");
                mysql_query("UPDATE `distributor` SET `password` = '$_POST[n_pass]' WHERE `distributor`.`d_id` = '$_SESSION[d_id]';")or die("failed ! updating query failed to save data");
